...
export function TouristMonitoring() {
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold">{today.total}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold text-blue-600">{today.foreign}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold text-green-600">{today.domestic}</div>
            <p className="text-xs text-muted-foreground mt-1">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold">{week_total}</div>
            <p className="text-xs text-muted-foreground mt-1">
